...
# Build
cd ${extracted_dir}
cp /mnt/clp/tools/scripts/cross-complie/android_armv8/template/libarchive/archive_entry.h ./libarchive
cp /mnt/clp/tools/scripts/cross-complie/android_armv8/template/libarchive/archive.h ./libarchive
...
cmake \
  -DENABLE_EXPAT=OFF  \
  -DCMAKE_INSTALL_PREFIX=${deb_output_dir}/../android_armv8 \
  -DCMAKE_FIND_ROOT_PATH=${deb_output_dir}/../android_armv8 \
